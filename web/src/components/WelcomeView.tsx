...
export function WelcomeView() {
  ...
  return (
    <div className="absolute inset-0 overflow-auto bg-stone-100 dark:bg-zinc-950">
      {/* Mobile layout: stacked icon-card + text-card */}
      ...
      {/* iPad / desktop layout: two-column with sample preview */}
      <div className="hidden md:flex min-h-full items-center justify-center px-10 py-16">
        <div className="w-full max-w-5xl grid grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="mt-6 text-[64px] leading-[0.95] font-bold tracking-tight">
              Stammbaum
            </h1>
            <p className="mt-6 max-w-md text-[18px] leading-snug text-black/60 dark:text-white/60">
              Öffne deinen Ahnenblatt-Export. Personen und Fotos werden lokal gespeichert
              und sind auch ohne Internet verfügbar.
            </p>
